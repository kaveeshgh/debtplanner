...
How to run:
In main folder do "npm run dev"
Then in another terminal "cd backend"
Then "python -m venv venv
.\venv\Scripts\Activate.ps1
pip install fastapi uvicorn pydantic pdfplumber numpy pandas matplotlib python-multipart" 
Then do "uvicorn main:app --reload"
